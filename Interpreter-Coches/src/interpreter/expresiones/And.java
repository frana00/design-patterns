...
// Expresión no terminal para combinar dos expresiones con AND
public class And implements ExpresionBusqueda {
    private ExpresionBusqueda exp1;
    private ExpresionBusqueda exp2;

    public And(ExpresionBusqueda exp1, ExpresionBusqueda exp2) {
        this.exp1 = exp1;
        this.exp2 = exp2;
    }
